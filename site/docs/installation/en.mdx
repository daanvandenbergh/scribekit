...
Link only what you need. `scribekit-hero` and `scribekit-docs-github-pages` each stand alone, so you can skip either. The two content skills are the exception, and the next section says why. See [Skills](/docs/skills) for what each skill does.
