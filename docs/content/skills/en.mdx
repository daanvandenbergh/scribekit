...
| --- | --- | --- | --- |
| `scribekit-blog` | `write`, `rewrite` | `--scan`, `--no-hero`, `--no-translations` | [scribekit-blog](/scribekit-blog) |
| `scribekit-docs` | `write`, `rewrite`, `reorganize`, `deep-verify` | `--scan`, `--no-hero` | [scribekit-docs](/scribekit-docs) |
| `scribekit-hero` | `blog-hero`, `regenerate-heroes`, `docs-hero`, `regenerate-docs-heroes`, `readme-hero`, `tune-gradients` | none | [scribekit-hero](/scribekit-hero) |
| `scribekit-docs-github-pages` | none (one linear job) | `--verify` | [scribekit-docs-github-pages](/scribekit-docs-github-pages) |
...
`node_modules`. The exact commands are in [Installation](/installation).
